...
BEGIN 
    ...
    -- Fetch ISBN and Title while avoiding column shadowing
...
-- testing function and return_records

issued_id = IS135
ISBN = WHERE isbn = '978-0-451-52994-2'
...
BEGIN
   ...
   ELSE
        RAISE NOTICE 'Sorry to inform you the book you have requested is not available book_isbn: %', p_issued_book_isbn; 
   END IF;
END;
$$;
SELECt * FROM books;
